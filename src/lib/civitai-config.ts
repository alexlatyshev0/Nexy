export const GLOBAL_STYLE = {
  ...
  negative: "ugly, deformed, noisy, blurry, low quality, bad anatomy, bad proportions, extra limbs, cloned face, disfigured, gross proportions, malformed limbs, missing arms, missing legs, extra arms, extra legs, fused fingers, too many fingers, long neck, username, watermark, signature, text",
};
...
export function buildPrompt(
  ...
  // "none" - only use the scene prompt, no style prefixes
  if (styleVariant === 'none') {
    return {
      prompt: scenePrompt,
      negativePrompt: "ugly, deformed, bad anatomy, child, underage, minor",
    };
  }
